({
    // 保存処理
    savePj: function(component, KAISYA_RIREKI__c, callback) {
    ...
    upsertHandler: function(component, event, helper) {
        ...
        this.savePj(component, pj, function(response){
            ...
            if (state == "SUCCESS") {
                ...
                debugger;
                var title = "会社名 \""+ cmpView.recordInfo.KAISYAMEI__c + "\" が" + acctionStr + "されました。";
